...
Disk partitioning is the process of dividing a storage disk (such as a hard drive or SSD) into distinct, separate sections called partitions. Each partition behaves as if it were an independent disk, allowing the operating system and users to organize, manage, and use the storage space more effectively.<br />
    * Hostname: naharumi42
    * Username: naharumi
...
6. **Users and groups manipulation** :busts_in_silhouette:<br /><br />
...
9. **Strong password policy** :closed_lock_with_key:<br />
    * Password aging
